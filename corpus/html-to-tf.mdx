---
title: "Transform HTML Document Directories to Text-Fabric"
sidebarTitle: "HTML to TF"
description: "convert_html_to_tf() turns HTML files into a Text-Fabric dataset. Basic mode yields document→element→word nodes; advanced mode promotes semantic elements."
---
