---
title: "Fetch Text-Fabric Datasets from a Git Repository"
sidebarTitle: "Fetch from Git"
description: "Use fetch_datasets_from_git() to shallow-clone a git repository and automatically locate all Text-Fabric dataset directories containing otext.tf and otype.tf."
---
