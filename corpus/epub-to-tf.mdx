---
title: "Convert EPUB Ebooks to Queryable Text-Fabric Datasets"
sidebarTitle: "EPUB to TF"
description: "convert_epub_to_tf() converts any EPUB into a TF dataset with a book→chapter→element→paragraph→word node hierarchy, ready for Context Fabric MCP queries."
---
