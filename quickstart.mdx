---
title: "Context Fabric Quickstart: Install, Load, and Query"
sidebarTitle: "Quickstart"
description: "Install corpora-py, start the cf-mcp server, and run your first corpus search against a biblical text dataset in under five minutes."
---
