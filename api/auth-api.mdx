...
description: "Python API reference for exegia.auth: sign-in and sign-up functions, the CurrentUser dataclass, and helper utilities for OTP and anonymous sessions."
---
