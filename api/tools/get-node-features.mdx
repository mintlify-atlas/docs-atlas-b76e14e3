...
description: "Looks up named feature values for a list of integer node IDs. Returns a formatted table with node ID, section reference, and one column per feature. Max 100 nodes."
---
