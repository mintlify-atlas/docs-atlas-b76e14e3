---
title: "search_csv(): Export search results to CSV"
sidebarTitle: "search_csv"
description: "Runs a query template and writes every matched node with selected feature values to a CSV file. Requires stdio transport. Defaults to otype, lex, pos, gloss columns."
---
