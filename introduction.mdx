...
description: "Context Fabric is a Python library and MCP server that exposes graph-annotated biblical and religious text corpora to AI assistants and developers via 11 query tools."
---
